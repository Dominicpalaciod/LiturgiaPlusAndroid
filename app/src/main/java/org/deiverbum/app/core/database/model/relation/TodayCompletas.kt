...
import org.deiverbum.app.core.model.data.Completas
import org.deiverbum.app.core.model.data.CompletoriumNew
...
fun TodayCompletas.asExternalModel() = LiturgiaNew(
    CompletoriumNew(kyrie.entity.asExternalModel(), lhHymn = hymn.entity.asExternalModel())
)
/*
fun TodayCompletas.asExternalModel() = Liturgy(
    org.deiverbum.app.core.model.data.LiturgyType.Completorium(lhHymn = nightPrayer.hymn.asExternalModel())
)*/